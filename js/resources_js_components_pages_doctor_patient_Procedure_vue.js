"use strict";
(self["webpackChunkmedic_hospital_management"] = self["webpackChunkmedic_hospital_management"] || []).push([["resources_js_components_pages_doctor_patient_Procedure_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _services_account__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @services/account */ "./resources/js/services/account.js");
/* harmony import */ var _services_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @services/core */ "./resources/js/services/core.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    url: function url() {
      return '/procedures/' + this.invoice.patient_id;
    },
    procedureItems: function procedureItems() {
  ...
  methods: {
    ...
    submitProcedureRequest: function submitProcedureRequest() {
      var _this = this;
      this.form.processing = true;
      this.form.ledger_id = this.invoice.id;
      var vm = this;
      var procedure = this.items.find(function (item) {
        return item.id === vm.form.item_id;
      });
      if (this.invoice.cash_credit === 0) {
        if (!procedure.cash_price) {
          this.$toast.error('The procedure billing price has not been set');
          return;
        }
      }
      if (this.invoice.cash_credit === 1) {
        if (!procedure.scheme_price) {
          this.$toast.error('The procedure billing price has not been set');
          return;
        }
      }
      ...
      this.form.post('/patient-bills').then(function () {
        _this.$toast.success('Procedure has been requested');
        _this.$bvModal.hide('procedure-modal');
      })["catch"]();
    },
    deleteProcedure: function deleteProcedure(rowData) {
      var _this2 = this;
      if (rowData.paid) {
        this.$toast.error('The procedure has been paid for. You cannot paid transactions');
        return;
      }
      this.$toast.question('Do you want to continue?', 'Deleting Procedure!').then(function () {
        _this2.$httpClient.post('/bills/reverse', {
          comments: 'Deleted by doctor',
          detail_id: rowData.id,
          ledger_id: rowData.ledger_id,
          source: '1'
        }).then(function () {
          _this2.vuetable.reload();
          _this2.$toast.success('The procedure has been deleted');
        })["catch"](function () {
          _this2.$toast.error('The procedure could not be deleted. Please try again later');
        });
      });
    },
    ...
    findAllInvoices: function findAllInvoices() {
      var _this3 = this;
      _services_core__WEBPACK_IMPORTED_MODULE_2__["default"].findAllHeaders({
        sort: '-date',
        page: {
          size: 20000
        },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=template&id=b7ecaba2&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=template&id=b7ecaba2& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_c("h2", [_vm._v("Procedures")]), _vm._v(" "), _c("div", {
    staticClass: "card-actions"
  }, [_vm.invoice.processed_at === null ? _c("button", {
    directives: [{
      name: "b-modal",
      rawName: "v-b-modal:procedure-modal",
      arg: "procedure-modal"
    }],
        ...
        return [_vm.invoice.processed_at === null ? _c("div", {
          ...
          on: {
            click: function click($event) {
              return _vm.deleteProcedure(props.rowData);
            }
          }
        }, [_c("i", {
    ...
    on: {
      submit: function submit($event) {
        ...
        return _vm.submitProcedureRequest.apply(null, arguments);
      }
    }
  }, [_c("div", {
  ...
  }, [_vm._v("Procedure")]), _vm._v(" "), _c("v-select", {
    attrs: {
      options: _vm.procedureItems,
      label: "name",
      clearable: false,
...
/***/ "./resources/js/components/pages/doctor/patient/Procedure.vue":
/*!********************************************************************!*\
  !*** ./resources/js/components/pages/doctor/patient/Procedure.vue ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Procedure_vue_vue_type_template_id_b7ecaba2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Procedure.vue?vue&type=template&id=b7ecaba2& */ "./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=template&id=b7ecaba2&");
/* harmony import */ var _Procedure_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Procedure.vue?vue&type=script&lang=js& */ "./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Procedure_vue_vue_type_template_id_b7ecaba2___WEBPACK_IMPORTED_MODULE_0__.render,
  _Procedure_vue_vue_type_template_id_b7ecaba2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/pages/doctor/patient/Procedure.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************!*\
  !*** ./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Procedure_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Procedure.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Procedure_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=template&id=b7ecaba2&":
/*!***************************************************************************************************!*\
  !*** ./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=template&id=b7ecaba2& ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Procedure_vue_vue_type_template_id_b7ecaba2___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Procedure_vue_vue_type_template_id_b7ecaba2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Procedure_vue_vue_type_template_id_b7ecaba2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Procedure.vue?vue&type=template&id=b7ecaba2& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/doctor/patient/Procedure.vue?vue&type=template&id=b7ecaba2&");


/***/ })

}]);
//# sourceMappingURL=resources_js_components_pages_doctor_patient_Procedure_vue.js.map